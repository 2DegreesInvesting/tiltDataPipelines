...
def check_signalling_issues(table_name):
    ...
    for table_name in table_name_list:
        dataframe = read_table(spark_generate, table_name)
        dataframe_columns = dataframe.columns
        df = calculate_filled_values(spark_generate, dataframe, dataframe_columns)
        ...
        filled_values_data = filled_values_data.union(filled_values_data)
        df.head(5)
    ...
    for table_name in signalling_checks_dictionary:
            ...
            dataframe_2 = read_table(spark_generate, table_name)
            if check_types == 'values within list':
                df_2 = check_value_within_list(spark_generate, dataframe_2, column_name, value_list)
                ...
                df_3 = check_values_in_range(spark_generate, dataframe_2, column_name, range_start, range_end)
