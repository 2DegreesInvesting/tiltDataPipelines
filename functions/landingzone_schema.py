...
landingzone_schema = {
        ...
        'companies_companyinfo_landingzone': {
            'columns': StructType([
                ...
                StructField('Kamer_van_Koophandel_nummer_12-cijferig', StringType(), False),
                ...
                StructField('Klasse_aantal_medewerkers_Omschrijving', StringType(), False),
                StructField('Aantal_medewerkers_van_concern_op_locatie', StringType(), False),
                StructField('Klasse_aantal_medewerkers_locatie', StringType(), False),
                StructField('Klasse_aantal_medewerkers_locatie_Omschrijving', StringType(), False),
                ...
                StructField('SBI-code_2-cijferig_locatie_Omschrijving', StringType(), False),
                StructField('SBI-code_segment_locatie', StringType(), False),
                StructField('SBI-code_segment_locatie_Omschrijving', StringType(), False),
                ...
                StructField('Klasse_aantal_locaties_van_concern_Omschrijving', StringType(), False),
                StructField('Aantal_medewerkers_concern', StringType(), False),
                StructField('Klasse_aantal_medewerkers_concern', StringType(), False),
                StructField('Klasse_aantal_medewerkers_concern_Omschrijving', StringType(), False),
                ...
                StructField('SBI-code_2-cijferig_concern_Omschrijving', StringType(), False),
                StructField('SBI-code_segment_concern', StringType(), False),
                StructField('SBI-code_segment_concern_Omschrijving', StringType(), False),
                StructField('Subsidie_bedrag_concern', StringType(), False),
                StructField('Klasse_subsidie_bedrag_concern', StringType(), False),
                StructField('Klasse_subsidie_bedrag_concern_Omschrijving', StringType(), False),
                StructField('Grootverbruik_of_kleinverbruik_Omschrijving', StringType(), True),
                StructField('Bouwjaar_verblijfsobject', StringType(), True),
                StructField('Oppervlakte_verblijfsobject', StringType(), True),
                StructField('Klasse_oppervlakte_verblijfsobject_Omschrijving', StringType(), False),
                StructField('Hoofd_gebruiksdoel_verblijfsobject_Omschrijving', StringType(), False),
                StructField('Energielabel_verblijfsobject_Omschrijving', StringType(), False),
                StructField('Energielabel_status_verblijfsobject_Omschrijving', StringType(), False),
                StructField('Type_bedrijfsverzamelpand_Omschrijving', StringType(), True),
                ...
                StructField('Klasse_geconsolideerd_resultaat_Omschrijving', StringType(), True),
                StructField('Omzet_geconsolideerd', StringType(), True),
                StructField('Klasse_geconsolideerde_omzet', StringType(), True),
                StructField('Klasse_geconsolideerde_omzet_Omschrijving', StringType(), True),
                StructField('Totaal_aantal_personenwagens_locatie', StringType(), False),
                StructField('Totaal_aantal_lichte_bedrijfswagens_locatie', StringType(), False),
                StructField('Totaal_aantal_vrachtwagens_locatie', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_personenwagens_locatie', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_lichte_bedrijfswagens_locatie', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_vrachtwagens_locatie', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_personenwagens_locatie_Omschrijving', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_lichte_bedrijfswagens_locatie_Omschrijving', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_vrachtwagens_locatie_Omschrijving', StringType(), False),
                StructField('Percentage_benzine_personenwagens_locatie', StringType(), True),
                StructField('Percentage_diesel_personenwagens_locatie', StringType(), True),
                StructField('Percentage_hybride_personenwagens_locatie', StringType(), True),
                StructField('Percentage_elektrische_personenwagens_locatie', StringType(), True),
                StructField('Percentage_overig_brandstof_personenwagens_locatie', StringType(), True),
                StructField('Percentage_benzine_lichte_bedrijfswagens_locatie', StringType(), True),
                StructField('Percentage_diesel_lichte_bedrijfswagens_locatie', StringType(), True),
                StructField('Percentage_hybride_lichte_bedrijfswagens_locatie', StringType(), True),
                StructField('Percentage_elektrische_lichte_bedrijfswagens_locatie', StringType(), True),
                StructField('Percentage_overig_brandstof_lichte_bedrijfswagens_locatie', StringType(), True),
                StructField('Percentage_benzine_vrachtwagens_locatie', StringType(), True),
                StructField('Percentage_diesel_vrachtwagens_locatie', StringType(), True),
                StructField('Percentage_hybride_vrachtwagens_locatie', StringType(), True),
                StructField('Percentage_elektrische_vrachtwagens_locatie', StringType(), True),
                StructField('Percentage_overig_brandstof_vrachtwagens_locatie', StringType(), True),
                StructField('Totaal_aantal_personenwagens_concern', StringType(), False),
                StructField('Totaal_aantal_lichte_bedrijfswagens_concern', StringType(), False),
                StructField('Totaal_aantal_vrachtwagens_concern', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_personenwagens_concern', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_lichte_bedrijfswagens_concern', StringType(), False),
                StructField('Voorspelling_waarde_totaal_aantal_vrachtwagens_concern', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_personenwagens_concern_Omschrijving', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_lichte_bedrijfswagens_concern_Omschrijving', StringType(), False),
                StructField('Voorspelling_klasse_totaal_aantal_vrachtwagens_concern_Omschrijving', StringType(), False),
                StructField('Percentage_benzine_personenwagens_concern', StringType(), True),
                StructField('Percentage_diesel_personenwagens_concern', StringType(), True),
                StructField('Percentage_hybride_personenwagens_concern', StringType(), True),
                StructField('Percentage_elektrische_personenwagens_concern', StringType(), True),
                StructField('Percentage_overig_brandstof_personenwagens_concern', StringType(), True),
                StructField('Percentage_benzine_lichte_bedrijfswagens_concern', StringType(), True),
                StructField('Percentage_diesel_lichte_bedrijfswagens_concern', StringType(), True),
                StructField('Percentage_hybride_lichte_bedrijfswagens_concern', StringType(), True),
                StructField('Percentage_elektrische_lichte_bedrijfswagens_concern', StringType(), True),
                StructField('Percentage_overig_brandstof_lichte_bedrijfswagens_concern', StringType(), True),
                StructField('Percentage_benzine_vrachtwagens_concern', StringType(), True),
                StructField('Percentage_diesel_vrachtwagens_concern', StringType(), True),
                StructField('Percentage_hybride_vrachtwagens_concern', StringType(), True),
                StructField('Percentage_elektrische_vrachtwagens_concern', StringType(), True),
