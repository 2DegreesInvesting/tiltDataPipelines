    ...
    table_dict = {
        ...
        'sea_food_landingzone': {
            'columns':  StructType([
                ...
                StructField('supply_chain_wholesale_distribution',
                            StringType(), True),
                StructField('supply_chain_retail', StringType(), True),
                StructField('supply_chain_foodservice', StringType(), True),
                StructField('supply_chain_fishing_vessels',
                            StringType(), True),
                StructField(
                    'supply_chain_fishing_and_aquaculture_gear_equipment', StringType(), True),
                StructField('supply_chain_other', StringType(), True),
                StructField(
                    'full_species_disclosure_for_entire_portfolio', StringType(), True),
                StructField(
                    'full_species_disclosure_for_at_least_part_of_portfolio', StringType(), True),
                ...
                StructField('reporting_precision_pt_score',
                            StringType(), True),
                StructField(
                    'world_benchmarking_alliance_seafood_stewardship_index', StringType(), True),
                StructField('ocean_health_index_score_2012',
                            StringType(), True),
                StructField('ocean_health_index_score_2021',
                            StringType(), True),
                StructField(
                    'ocean_health_index_score_percent_change_2021_2012', StringType(), True),
                StructField('fish_source_score_management_quality',
                            StringType(), True),
                StructField('fish_source_score_managers_compliance',
                            StringType(), True),
                StructField('fish_source_score_fishers_compliance',
                            StringType(), True),
                StructField('fish_source_score_current_stock_health',
                            StringType(), True),
                StructField('fish_source_score_future_stock_health',
                            StringType(), True),
                StructField(
                    'sea_around_us_unreported_total_catch_percent', StringType(), True),
                StructField(
                    'sea_around_us_bottom_trawl_total_catch_percent_35', StringType(), True),
                StructField(
                    'sea_around_us_gillnets_total_catch_percent', StringType(), True),
                StructField(
                    'global_fishing_index_data_availability_on_stock_sustainability', StringType(), True),
                StructField(
                    'global_fishing_index_proportion_of_assessed_fish_stocks_that_is_sustainable', StringType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_sustainable', StringType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_overfished', StringType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_not_assessed', StringType(), True),
                StructField(
                    'global_fishing_index_fisheries_governance_score', StringType(), True),
                StructField(
                    'global_fishing_index_alignment_with_international_standards_for_protecting_worker_rights_and_safety_in_fisheries_assessment_score', StringType(), True),
                StructField(
                    'global_fishing_index_fishery_subsidy_program_assessment_score', StringType(), True),
                StructField(
                    'global_fishing_index_knowledge_on_fishing_fleets_assessment_score', StringType(), True),
                StructField(
                    'global_fishing_index_compliance_monitoring_and_surveillance_programs_assessment_score', StringType(), True),
                StructField(
                    'global_fishing_index_severity_of_fishery_sanctions_assessment_score', StringType(), True),
                StructField(
                    'global_fishing_index_access_of_foreign_fishing_fleets_assessment_score', StringType(), True)
            ]
            ),
            'container': 'landingzone',
        ...
        'sea_food_raw': {
            'columns':  StructType([
                ...
                StructField('supply_chain_fishing_vessels',
                            BooleanType(), True),
                StructField(
                    'supply_chain_fishing_and_aquaculture_gear_equipment', BooleanType(), True),
                StructField('supply_chain_other', BooleanType(), True),
                StructField(
                    'full_species_disclosure_for_entire_portfolio', BooleanType(), True),
                StructField(
                    'full_species_disclosure_for_at_least_part_of_portfolio', BooleanType(), True),
                StructField('species_disclosure_text', StringType(), True),
                StructField('seafood_exposure', StringType(), True),
                StructField('reference', StringType(), True),
                StructField('websites', StringType(), True),
                ...
                StructField('reporting_precision_pt_score',
                            DoubleType(), True),
                StructField(
                    'world_benchmarking_alliance_seafood_stewardship_index', DoubleType(), True),
                StructField('ocean_health_index_score_2012',
                            DoubleType(), True),
                StructField('ocean_health_index_score_2021',
                            DoubleType(), True),
                StructField(
                    'ocean_health_index_score_percent_change_2021_2012', DoubleType(), True),
                StructField('fish_source_score_management_quality',
                            DoubleType(), True),
                StructField('fish_source_score_managers_compliance',
                            DoubleType(), True),
                ...
                StructField('fish_source_score_future_stock_health',
                            DoubleType(), True),
                StructField(
                    'sea_around_us_unreported_total_catch_percent', DoubleType(), True),
                StructField(
                    'sea_around_us_bottom_trawl_total_catch_percent_35', DoubleType(), True),
                StructField(
                    'sea_around_us_gillnets_total_catch_percent', DoubleType(), True),
                StructField(
                    'global_fishing_index_data_availability_on_stock_sustainability', DoubleType(), True),
                StructField(
                    'global_fishing_index_proportion_of_assessed_fish_stocks_that_is_sustainable', DoubleType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_sustainable', DoubleType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_overfished', DoubleType(), True),
                StructField(
                    'global_fishing_index_proportion_of_1990_2018_catches_that_is_not_assessed', DoubleType(), True),
                StructField(
                    'global_fishing_index_fisheries_governance_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_alignment_with_international_standards_for_protecting_worker_rights_and_safety_in_fisheries_assessment_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_fishery_subsidy_program_assessment_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_knowledge_on_fishing_fleets_assessment_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_compliance_monitoring_and_surveillance_programs_assessment_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_severity_of_fishery_sanctions_assessment_score', DoubleType(), True),
                StructField(
                    'global_fishing_index_access_of_foreign_fishing_fleets_assessment_score', DoubleType(), True),
                StructField('from_date', DateType(), False),
                StructField('to_date', DateType(), False),
                StructField('tiltRecordID', StringType(), False),
            ]
        ...
        'categories_sector_ecoinvent_delimited_landingzone': {
            'columns':  StructType([
                StructField(
                    'categories_sector_ecoinvent_delimited_id', StringType(), False),
                StructField('categories_id', StringType(), True),
                StructField('sector_ecoinvent_delimited_id',
                            StringType(), True)
            ]
            ),
            'container': 'landingzone',
        ...
        'sector_ecoinvent_delimited_sector_ecoinvent_landingzone': {
            'columns':  StructType([
                StructField(
                    'sector_ecoinvent_delimited_sector_ecoinvent_id', StringType(), False),
                StructField('sector_ecoinvent_delimited_id',
                            StringType(), True),
        ...
        'ecoinvent-v3.9.1_landingzone': {
            'columns':  StructType([
                ...
                StructField('unit', StringType(), True),
                StructField(
                    'method_category_indicator_product_information', StringType(), True),
                StructField('product_inputs_tbc', StringType(), True),
                StructField(
                    'ipcc_2021_climate_change_global_warming_potential_gwp100_kg_co2_eq', StringType(), True)
            ]
            ),
            'container': 'landingzone',
        ...
        'ecoinvent-v3.9.1_raw': {
            'columns':  StructType([
                ...
                StructField('product_inputs_tbc', StringType(), True),
                StructField(
                    'ipcc_2021_climate_change_global_warming_potential_gwp100_kg_co2_eq', DoubleType(), True),
                StructField('from_date', DateType(), False),
                StructField('to_date', DateType(), False),
                StructField('tiltRecordID', StringType(), False),
            ]
        ...
        'emissions_profile_upstream_products_ecoinvent_landingzone': {
            'columns':  StructType([
                ...
                StructField('input_co2_footprint', StringType(), True),
                StructField('input_isic_4digit', StringType(), True),
                StructField('input_reference_product_name',
                            StringType(), True),
                StructField('input_tilt_sector', StringType(), True),
                StructField('input_tilt_subsector', StringType(), True),
                StructField('input_unit', StringType(), True),
        ...
        'pctr_product_result_landingzone': {
            'columns':  StructType([
                ...
                StructField('matching_certainty_company_average',
                            StringType(), True),
                StructField('company_city', StringType(), True), StructField(
                    'postcode', StringType(), True),
                StructField('address', StringType(), True), StructField(
                    'main_activity', StringType(), True),
                StructField('activity_uuid_product_uuid', StringType(), True)
            ]
            ),
            'container': 'landingzone',
