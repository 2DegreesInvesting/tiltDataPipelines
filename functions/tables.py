...
def get_table_definition(table_name: str = '') -> dict:
    ...
    table_dict = {
        ...
        'ecoinvent_input_data_relevant_columns_landingzone': {
            ...
            'container': 'landingzone',
            'location': 'tiltIndicatorBefore/ecoinvent_input_data_relevant_columns.xlsx',
            'type': 'ecoInvent',
            'partition_column' : '',
            'quality_checks': []
        },
        ...
        'ep_companies_eurocaps_landingzone': {
            'columns' :  StructType([
                StructField('companies_id', StringType(), False), 
                StructField('company_name', StringType(), True), 
                StructField('country', StringType(), True), 
            ...
            'container': 'landingzone',
            'location': 'tiltIndicatorBefore/eurocaps_ep_companies.csv',
            'type': 'ecoInvent',
            'partition_column' : '',
            'quality_checks': []
        },
        'ep_companies_eurocaps_raw': {
            'columns' :  StructType([
                StructField('companies_id', StringType(), False), 
                StructField('company_name', StringType(), True), 
                StructField('country', StringType(), True), 
            ...
            'container': 'raw',
            'location': 'ep_companies_eurocaps',
            'type': 'parquet',
            'partition_column' : '',
            'quality_checks': []
        },
