...
def get_table_definition(table_name: str) -> dict:
    ...
    table_dict = {
        ...
        'columns' :  StructType([
                ...
                StructField('company_name', StringType(), True), 
                StructField('country', StringType(), True), 
                StructField('emission_share_ew', FloatType(), True), 
                StructField('emission_share_bc', FloatType(), True), 
                StructField('emission_share_wc', FloatType(), True), 
                StructField('emission_category', StringType(), True), 
                StructField('benchmark', StringType(), True), 
                StructField('Co2e_upper', FloatType(), True), 
                StructField('Co2e_lower', FloatType(), True), 
                StructField('matching_certainty_company_average', StringType(), True), 
                StructField('company_city', StringType(), True), 
                StructField('postcode', StringType(), True), 
                StructField('address', StringType(), True), 
        ...
        'columns' :  StructType([
                ...
                StructField('company_city', StringType(), True), 
                StructField('country', StringType(), True), 
                StructField('emission_upstream_share_ew', FloatType(), True), 
                StructField('emission_upstream_share_bc', FloatType(), True), 
                StructField('emission_upstream_share_wc', FloatType(), True), 
                StructField('Co2e_input_lower', FloatType(), True), 
                StructField('Co2e_input_upper', FloatType(), True), 
                StructField('emission_upstream_category', StringType(), True), 
                StructField('benchmark', StringType(), True), 
                StructField('matching_certainty_company_average', StringType(), True), 
                StructField('postcode', StringType(), True), 
        ...
        'columns' :  StructType([
                ...
                StructField('company_name', StringType(), True), 
                StructField('country', StringType(), True), 
                StructField('sector_share_ew', FloatType(), True), 
                StructField('sector_share_bc', FloatType(), True), 
                StructField('sector_share_wc', FloatType(), True), 
                StructField('sector_category', StringType(), True), 
                StructField('SERT', StringType(), True), 
                StructField('scenario', StringType(), True), 
                StructField('year', IntegerType(), True), 
        ...
        'columns' :  StructType([
                ...
                StructField('company_name', StringType(), True), 
                StructField('country', StringType(), True), 
                StructField('sector_upstream_share_ew', FloatType(), True), 
                StructField('sector_upstream_share_bc', FloatType(), True), 
                StructField('sector_upstream_share_wc', FloatType(), True), 
                StructField('sector_upstream_category', StringType(), True), 
                StructField('scenario', StringType(), True), 
                StructField('SERT', StringType(), True), 
                StructField('year', IntegerType(), True), 
