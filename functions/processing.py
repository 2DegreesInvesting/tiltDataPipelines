...
def generate_table(table_name: str) -> None:
    ...
    if table_name == 'companies_europages_raw':
        ...
        tilt_scenario_mapper_raw = CustomDF(
            'tilt_scenario_mapper_raw', spark_generate, initial_df=tilt_scenario_mapper_landingzone.data)

        tilt_scenario_mapper_raw.write_table()
        ...
        scenario_targets_IPR_raw = CustomDF(
            'scenario_targets_IPR_raw', spark_generate, initial_df=scenario_targets_IPR_NEW_landingzone.data)
        ...
        scenario_targets_WEO_raw = CustomDF(
            'scenario_targets_WEO_raw', spark_generate, initial_df=scenario_targets_WEO_NEW_landingzone.data)
    ...
    #     geographies_related.write_table()
        ...
        ecoinvent_co2_landingzone.convert_data_types(
            ['IPCC_2021_climate_change_global_warming_potential_GWP100_kg_CO2_Eq'], DecimalType())
        ...
        ecoinvent_input_data_raw = CustomDF(
            'ecoinvent_input_data_raw', spark_generate, initial_df=ecoinvent_input_data_relevant_columns_landingzone.data)
